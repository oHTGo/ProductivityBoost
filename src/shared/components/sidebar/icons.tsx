...
export const EmailIcon: FC<IconProps> = ({ className, onClick }) => (
  <svg className={className} onClick={onClick} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50">
...
export const CalendarIcon: FC<IconProps> = ({ className, onClick }) => (
  <svg className={className} onClick={onClick} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 122.88 122.89">
...
export const TranslatorIcon: FC<IconProps> = ({ className, onClick }) => (
  <svg className={className} onClick={onClick} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" fill="none">
    <path
